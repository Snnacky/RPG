...
public class DamageCalculator
{
    ...
    public float GetElementalDamage(out ElementType elementType, out bool isCrit, Entity_Stats attacker_Stats, Entity_Stats defender_Stats, DamageData damageData)
    {
        ...
        float baseDamage = GetElementDamageByType(elementType, damageData);
        if (baseDamage == 0)
        {
        ...
        isCrit = CalcalateCritChance(attacker_Stats);//是否暴击
    ...
    //物理攻击
    public float GetPhysicalDamage(out bool isCrit,Entity_Stats attacker_Stats, Entity_Stats defender_Stats, DamageData damageData)
    {
        float baseDamage = attacker_Stats.offense.basicalPhysicalDamage.GetValue() + damageData.physicalDamage;
    ...
    //计算暴击率
    private bool CalcalateCritChance(Entity_Stats attacker_Stats)
    {
        //暴击率
    ...
    //计算暴击伤害
    private float CalculateCritPower(Entity_Stats attacker_Stats)
    {
        //暴击伤害
    ...
    private float GetElementDamageByType(ElementType elementType , DamageData damageData)
    {
        switch (elementType)
        {
            case ElementType.Ice:return damageData.chillDamage;
            case ElementType.Fire:return damageData.burnDamage;
            case ElementType.Lightning:return damageData.shockDamage;
